...
export function downloadBookingVoucher(booking, tour, settings) {
  ...
  doc.setFontSize(9)
  doc.setTextColor(220, 235, 225)
  doc.text(`Email ${settings?.contactEmail || 'hello@tripnz.co.nz'}  •  Phone/WhatsApp ${settings?.contactPhone || '021 144 9859'}`, 20, H - 7)
  doc.setTextColor(...accent)
  doc.setFont('helvetica', 'bold')
  doc.setFontSize(9)
  doc.text('www.tripnz.co.nz', W - 20, H - 10, { align: 'right' })

  doc.save(`Tripnz-Voucher-${booking.bookingRef}.pdf`)
}
